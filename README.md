...
- `report_max_rectangle_height_atr`
- `report_pump_dump_atr_mult`
- `report_impulse_atr_mult`
- `report_impulse_close_extreme`
- `report_impulse_body_ratio_min`
- `report_event_atr_mult`
- `report_event_close_extreme`
- `report_reclaim_ratio_min`
